...
contains
  ...
  subroutine tatu_io_write_output_json(output_file, in, labels, values, u_transmitter, u_frequency, u_receiver)
  ...
  end subroutine tatu_io_write_output_json

  subroutine tatu_io_write_output_ssv(output_file, output_data)
